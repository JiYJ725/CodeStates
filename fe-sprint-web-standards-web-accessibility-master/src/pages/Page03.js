...
const Page03 = () => {
  return (
    <article>
      <h1>문제 3 : 대체 텍스트</h1>
      <p>
        시각적 요소를 인지하지 못하는 사용자를 위해서 텍스트가 아닌 콘텐츠를
        제공할 땐 해당 콘텐츠가 어떤 콘텐츠인지 설명하는 대체 텍스트를
        작성해주어야 합니다.
        <br />
        우측 문제 가이드와 유어클래스 콘텐츠를 참고하여 아래 이미지들의 웹
        접근성을 개선해보세요.
      </p>
      <li>
        리팩토링 하기 전, 스크린 리더를 사용하여 아래 이미지들을 어떻게
        인식하는지 확인해보세요.
      </li>
      <li>
        리팩토링 후에 다시 한 번 스크린 리더를 사용하여 개선된 웹 접근성을
        확인해보세요.
      </li>
      <section>
        <h2>귀여운 동물 사진들</h2>
        <section>
          ...
          <img
            src={catImage}
            alt="코리안 쇼트 고양이가 한쪽 눈을 찡긋하는 이미지"
          />
        </section>
        <section>
          <h3>예시 2</h3>
        ...
        <section>
          ...
          <img src={rabbitImage} alt="누런색 토끼" />
        </section>
        <section>
          <h3>예시 4</h3>
        ...
        <section>
          <h3>예시 5</h3>
          <li>
            이미지를 충분히 설명해주는 인접 요소가 있다면 대체 텍스트를 작성하지
            않아도 됩니다.
            <li>내용이 중복된다면 오히려 작성하지 않는 것이 좋습니다.</li>
          </li>
          <img src={redPandaImage} alt="레서 팬더 이미지" />
